...
namespace StudentManagment.Migrations
{
    ...
    [Migration("20250303114554_change-course-credit-to-decimal")]
    partial class changecoursecredittodecimal
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudentManagment.Models.Course_v1_1", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagment.Models.Enrollment_v1_1", b =>
                {
                    ...
                    b.ToTable("Enrollments_v1_1");
                });

            modelBuilder.Entity("StudentManagment.Models.Enrollment_v1_2", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudentManagment.Models.Enrollment_v1_2", b =>
                {
                    b.HasOne("StudentManagment.Models.Course_v1_1", "Course")
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
